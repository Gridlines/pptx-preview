/**
 * Render all slides of Project Lightning Credit Memo PPTX to HTML and save to slide-captures/
 */
...
describe('Render Project Lightning Credit Memo slides to HTML', () => {
  it('should render and save all slides to a single HTML', async () => {
    const pptxPath = resolve(__dirname, 'fixtures/Project Lightning Credit Memo - 9.16.22.pptx');
...
<html>
<head><meta charset="utf-8"><title>Project Lightning Credit Memo - 9.16.22 - All Slides</title>
<style>
...
${container.innerHTML}
    ...
    const outPath = resolve(outDir, 'project-lightning-credit-memo-all-slides.html');
