/**
 * Render all slides of Project Vortex Credit Highlights PPTX to HTML and save to slide-captures/
 */
...
describe('Render Project Vortex Credit Highlights slides to HTML', () => {
...
<html>
<head><meta charset="utf-8"><title>Project Vortex Credit Highlights - 2.15.23 - All Slides</title>
<style>
...
${container.innerHTML}
    ...
    const outPath = resolve(outDir, 'project-vortex-credit-highlights-all-slides.html');
